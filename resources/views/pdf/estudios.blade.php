...
<div>
    ...
    <div style="background-image: url('{{ public_path('img/back_receta.png')}}');background-repeat: no-repeat; background-position: center; min-height: 100% !important;">
        @foreach($estudios as $estudio)
        <p style="font-family: Verdana,Geneva,sans-serif; text-align: left; font-size: 13px; line-height:1px; column-count:2 !important;">{{ $estudio }}</p>
        @endforeach
