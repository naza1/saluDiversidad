        ...
        <div class="col-md-8">
            ...
            <form action="{{ url('paciente/' .$paciente->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="date" class="form-control" id="nacimiento" name="nacimiento" maxlength="250" placeholder="Fecha de Nacimiento" value="{{$paciente->FechaNacimiento}}" {{$paciente->FechaNacimiento ? 'readonly':''}}>
                    </div>
                </div>
