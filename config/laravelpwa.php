...
return [
    'name' => 'LaravelPWA',
    'manifest' => [
        'name' => env('APP_NAME', 'Programa Municipal en Salud y Diversidad MGP'),
        'short_name' => 'PMSyD MGP',
        'start_url' => '/',
        ...
        'icons' => [
            ...
            '128x128' => [
                'path' => '/images/icons/apple-icon-120x120.png',
                'purpose' => 'any'
            ],
            '144x144' => [
            ...
            '192x192' => [
                'path' => '/images/icons/android-icon-192x192.png',
                'purpose' => 'any'
            ],
            '384x384' => [
